...
from src.core import DuelingNetworkAgent
...
class TestDuelingNetwork():
    ...
    def rl_with_dueling_network_agent_on_cartpole_env(
        self,
        configuration_env,
        configuration_agent,
        configuration_ctrl
    ...
    def test_dueling_network_agent_should_work_on_cartpole_env(self, version):
        ...
        self.rl_with_dueling_network_agent_on_cartpole_env(
            configuration_env = configuration_env,
            configuration_agent = configuration_agent,
            configuration_ctrl = configuration_ctrl
        )
    ...
    @pytest.mark.evaluation
    def test_dueling_network_agent_should_perform_well_on_cartpole_v0_env(self):
    ...
    @pytest.mark.evaluation
    def test_dueling_network_agent_should_perform_well_on_cartpole_v1_env(self):
